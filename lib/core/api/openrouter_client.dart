...
class OpenRouterClient {
  ...
  Future<List<String>> fetchModels() async {
    try {
      ...
      final res = await http
          .get(
            ...
            headers: {
              ...
              'HTTP-Referer':
                  'https://jarvis.ai', // Optional: Replace with actual referrer
      ...
      if (res.statusCode != 200) {
        debugPrint(
          '[OpenRouter] Models fetch failed: ${res.statusCode} - ${res.body}',
        );
        throw Exception(
          'OpenRouter model fetch failed (${res.statusCode}): ${res.body}',
        );
      }
  ...
  Future<String> generate(
    ...
    try {
      ...
      if (res.statusCode != 200) {
        debugPrint(
          '[OpenRouter] Generate failed: ${res.statusCode} - ${res.body}',
        );
  ...
  Stream<String> generateStream(
    ...
    try {
      ...
      final resp = await client
          ...
          ); // Raised from 20s to allow long responses
      ...
      await for (final line
        ...
        if (trimmedLine.startsWith('data: ')) {
          ...
          try {
            ...
            debugPrint(
              '[OpenRouter] JSON parse error: $e for line: $trimmedLine',
            );
          }
        }
      }
