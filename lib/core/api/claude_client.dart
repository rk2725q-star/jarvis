...
class ClaudeApiClient {
  ...
  ClaudeApiClient({required this.apiKey, required this.model});
  ...
  Future<String> generate({
    ...
    try {
      ...
      if (response.statusCode != 200) {
        debugPrint(
          '[Claude] Generate failed: ${response.statusCode} - ${response.body}',
        );
        throw Exception(
  ...
  Stream<String> generateStream({
    ...
    try {
      ...
      if (response.statusCode != 200) {
        ...
        throw Exception(
          'Anthropic stream error ${response.statusCode}: $errBody',
        );
      }
