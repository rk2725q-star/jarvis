...
class GeminiApiClient {
  ...
  Map<String, dynamic> _buildBody({
    ...
    return {
      ...
      'generationConfig': {
        ...
        'maxOutputTokens':
            maxTokens ?? 8192, // Default 8192 — was erroneously 256
      },
    };
  }
  ...
  Future<String> generate(
    ...
    final resp = await generateWithTools(
      prompt,
  ...
  Future<AIResponse> generateWithTools(
    ...
    // Check for tool call
    final functionCall = parts.firstWhere(
      ...
      return AIResponse(
        toolCall: ToolCall(
          id: DateTime.now().millisecondsSinceEpoch
              .toString(), // Gemini doesn't use call IDs natively
