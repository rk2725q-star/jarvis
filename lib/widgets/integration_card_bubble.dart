...
class IntegrationCardBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final c2 = Color(int.tryParse(colorParts.length > 1 ? colorParts[1] : '0') ?? 0xFF3A86FF);
              ...
              children: [
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.link_rounded,
                          size: 12, color: c1.withValues(alpha: 0.7)),
                ...
                GestureDetector(
                  onTap: () => Navigator.of(context).push(
                    PageRouteBuilder(
                      pageBuilder: (_, _, _) =>
                          IntegrationBrowserScreen(integration: taskIntegration),
