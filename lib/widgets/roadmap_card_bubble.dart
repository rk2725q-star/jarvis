  ...
  Widget build(BuildContext context) {
    ...
    return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: accentCol.withValues(alpha: 0.35),
              width: 1.0,
            ),
            boxShadow: [
              BoxShadow(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      accentCol.withValues(alpha: 0.2),
                      secondaryCol.withValues(alpha: 0.1),
                    ],
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        _buildPill(
                          'Timeline: Years 1 - 12 (10-Year Plan)',
                          accentCol,
                        ),
