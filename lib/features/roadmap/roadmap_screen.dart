...
class _RoadmapScreenState extends State<RoadmapScreen>
  ...
  Widget _buildStatusReportMatrix() {
    final reports = [
      (
        ...
        decTarget:
            'Adversarial benchmark v1.0; neuro-symbolic pilot on 3 domains',
      ...
      (
        ...
        decTarget:
            'Standardized 50-step benchmark harness; baseline hierarchical planner with LLM subgoals',
      ...
      (
        ...
        decTarget:
            'Fine-tune multimodal models on egocentric video + action (Ego4D); pilot referential disambiguation',
      ...
      (
        ...
        decTarget:
            'Standardized few-shot evaluation protocol; benchmark modular/hypernetwork baselines',
      ...
      (
        ...
        decTarget:
            'Interactive social benchmark (negotiation/trust games); publish failure taxonomy',
      ...
      (
        ...
        decTarget:
            'Deploy monitoring wrappers for 100–200 step tool-use chains; mandatory red-team summaries',
        future:
            '1000+ step guarantees; formal verification; value drift prevention',
      ),
      (
        cap: 'Real-World Adaptability',
        state: 'Sim-to-real gap remains large',
        decTarget:
            'Standardized sim-to-real gap metrics across Habitat, Isaac Sim, real robots',
        future:
            'Robust OOD generalization; continual deployment without forgetting',
      ),
    ];
    ...
    final filtered = reports
        .where(
          (r) =>
              ...
              r.decTarget.toLowerCase().contains(_statusSearchQuery),
        )
        .toList();
  ...
  Widget _buildGovernanceActionsGrid() {
    final actions = [
      (
        ...
        desc:
            'Major training labs announce runs >10^25 FLOP 30 days in advance via shared registry.',
      ),
      (
        title: 'Red-Team Disclosure Mandate',
        time: 'By December 2026',
        desc:
            'No model >GPT-4-class capability released without public capabilities-and-failures card.',
      ),
      (
        title: 'Funding Reallocation Shift',
        time: 'By Q4 2026',
        desc:
            'Funding bodies shift ≥15% of AI budgets to robustness, safety audits, and evaluations.',
      ),
      (
        title: 'Policy Sandbox Launches',
        time: 'By December 2026',
        desc:
            'At least 2 national regulators launch formal AI sandboxes with published safety learning rules.',
      ),
    ];
  ...
  Widget _buildPillarsTab() {
    return ListView(
      ...
      children: [
        _buildSectionHeader(
          'PILLAR DELIVERABLES & EXPERIMENTS',
        ...
        _buildPillarTile(
          ...
          children: [
            _buildDeliverableRow(
              ...
              desc:
                  'Select common-sense questions or type a custom adversarial prompt to test the live model. Watch scores decay dynamically.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Configure force parameters (gravity, mass, medium) and ask counterfactual physics queries to analyze causal dependencies.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Constraint violation and recovery monitor environment for 100-200 step tool-use chains.',
            ),
            _buildDeliverableRow(
              id: 'A4',
              title: 'Sim-to-Real Gap Metrics Standard',
              desc:
                  'Robotics evaluation protocol tracking gap coefficient across Habitat, Isaac Sim, and real robots.',
            ),
          ],
        ),
        const SizedBox(height: 12),
        _buildPillarTile(
          ...
          children: [
            _buildDeliverableRow(
              ...
              desc:
                  'Submit queries to be formally parsed into SQL logic, run against local datasets, and synthesized side-by-side with raw outputs.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Ego4D VLM simulating kitchen instructions with grounding error logging.',
            ),
            _buildDeliverableRow(
              id: 'M2.3',
              title: 'Theory-of-Mind False-Belief Simulator',
              desc:
                  'Run perspective-taking test scenarios on the active model to check if it models private beliefs separate from ground truth.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Interactive forgetting curve chart comparing EWC, SI, replay, progressive networks over 10 tasks.',
        ...
        _buildPillarTile(
          ...
          children: [
            _buildDeliverableRow(
              ...
              desc:
                  'Submit commands to test our active safety heuristic parser. Wrapper detects drift and blocks malicious attempts.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Evaluate agent execution scripts against local security rules to generate validation certificates.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Public database cataloging AI specification gaming, deception, autonomy failures, and misuses.',
            ),
          ],
        ),
        const SizedBox(height: 12),
        _buildPillarTile(
          ...
          children: [
            _buildDeliverableRow(
              ...
              desc:
                  'Enter custom tasks. The active model plans a step queue. The runner intercepts critical actions, prompting user overrides.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  'Interactive block sorting scheduler showing the agent deferring critical or hazardous actions to the human supervisor.',
            ...
            _buildDeliverableRow(
              ...
              desc:
                  '50 human-AI tasks assessing deference rate and joint performance curves.',
            ),
          ],
        ),
        const SizedBox(height: 24),
  ...
  Widget _buildRisksList() {
    final risks = [
      (
        ...
        imp: 'High',
        mit:
            'AI optimizes proxy objectives in harmful ways (reward hacking). Audits of objective functions and safety constraints are required.',
      ),
      (
        ...
        imp: 'Very High',
        mit:
            'Systems appear aligned in training but act differently in deployment. Solved via mechanistic interpretability and red-teaming.',
      ),
      (
        ...
        imp: 'High',
        mit:
            'Capabilities accrue to few actors, reducing democratic control. Addressed through open research and public compute support.',
      ),
      (
        ...
        imp: 'Very High',
        mit:
            'Dual-use capabilities (bioengineering, cyber) amplified. Addressed via staged deployments, hardware export restrictions.',
      ),
      (
        ...
        imp: 'Medium',
        mit:
            'Rapid automation without transition paths. Addressed through policy sandboxes and economic transition planning.',
      ),
      (
        ...
        imp: 'High',
        mit:
            'Physical agents causing harm through planning errors. Mitigation involves formal boundaries and safety kill-switches.',
      ),
      (
        risk: 'Value Lock-in',
        like: 'Low',
        imp: 'Very High',
        mit:
            'Premature deployment of misaligned values at scale. Mitigation via citizens\' assemblies and value calibration tools.',
      ),
    ];
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'STAKEHOLDER ROLE DIFFERENTIATION',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 12,
                  fontWeight: FontWeight.bold,
              ...
              _buildRoleRow(
                'Academia',
                'Fundamental research, independent critique, causal theory, Theory of Mind.',
              ),
              _buildRoleRow(
                'Industry',
                'Engineering compute scale, infrastructure safety, real-world deployment data.',
              ),
              _buildRoleRow(
                'Policymakers',
                'Governance frameworks, compliance liability, public funding coordination.',
              ),
              _buildRoleRow(
                'Civil Society',
                'Public interest oversight, labor transition advocacy, ethical accountability.',
              ),
            ],
          ),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              _buildMechanismTile(
                ...
                'Federal/international institutes (like CERN) combining industry scale with academic oversight.',
              ),
              _buildMechanismTile(
                Icons.rule_folder_rounded,
                'Shared Infrastructure',
                'Establishing an "NIST for AI" to maintain dynamic open leaderboards and safety test harnesses.',
              ),
              _buildMechanismTile(
                Icons.directions_run_rounded,
                'Talent Mobility Programs',
                'Rotations and sabbaticals between government labs, industry, and academic posts.',
              ),
              _buildMechanismTile(
                Icons.security_rounded,
                'Policy Sandboxes',
                'Safe testing environments for auditing capabilities before wider commercial release.',
              ),
            ],
          ),
        ),
...
class _ExecutionTimelineWidget extends StatefulWidget {
  ...
  @override
  State<_ExecutionTimelineWidget> createState() =>
      _ExecutionTimelineWidgetState();
}
...
class _ExecutionTimelineWidgetState extends State<_ExecutionTimelineWidget> {
  ...
  _phases = const [
    (
      ...
      years: 'Years 1–3',
      goal:
          'Establish robust evaluation, benchmarking, and hybrid architectures.',
      milestones: [
        (
          code: 'M1.1',
          name: 'Adversarial Common-Sense Benchmarks',
          metric:
              'Human-normalized score <30% on adversarial physical/social tasks.',
          desc:
              'Create physical/social reasoning benchmarks checking compositional generalization.',
        ),
        (
          code: 'M1.2',
          name: 'Causal World Models',
          metric:
              'Intervention prediction accuracy; counterfactual consistency.',
          desc:
              'Integrate neural networks with differentiable causal simulators to learn cause-effect structures.',
        ),
        (
          code: 'M1.3',
          name: 'Continual Learning Protocols',
          metric:
              'Backward/forward transfer metrics; bounded forgetting curves.',
          desc:
              'Develop algorithms that learn new tasks sequentially without catastrophic forgetting.',
        ),
        (
          code: 'M1.4',
          name: 'Safety-Critical Evaluation Harness',
          metric:
              'Safety violation rate over 1000-step tasks; recovery success rate.',
          desc:
              'Standardized red-teaming protocols for long-horizon tasks with cascading failures.',
        ),
      ],
    ),
    (
      ...
      milestones: [
        (
          code: 'M2.1',
          name: 'Neuro-Symbolic Planning',
          metric:
              'Plan execution success rate over 50+ step tasks; replanning latency.',
          desc:
              'Hybrid systems combining LLM subgoal generation with symbolic/constraint planners.',
        ),
        (
          code: 'M2.2',
          name: 'Grounded Multimodal Meaning',
          metric:
              'Action grounding accuracy; referential disambiguation in physical tasks.',
          desc:
              'Language models trained with embodied interaction logs, not just text/images.',
        ),
        (
          code: 'M2.3',
          name: 'Social Reasoning Modules',
          metric:
              'Theory-of-mind games; false-belief task performance vs. humans.',
          desc:
              'Explicit theory-of-mind modules that model human beliefs, goals, and emotional states.',
        ),
        (
          code: 'M2.4',
          name: 'Value Alignment over Time',
          metric:
              'Constraint drift measurement; human evaluator consistency scores.',
          desc:
              'Techniques for maintaining behavioral constraints across extended interactions.',
        ),
      ],
    ),
    (
      ...
      years: 'Years 6–9',
      goal:
          'Demonstrate human-comparable sample efficiency and robustness in open-ended environments.',
      milestones: [
        (
          code: 'M3.1',
          name: 'Compositional Few-Shot Learning',
          metric: 'Few-shot transfer accuracy; concept compositionality tests.',
          desc:
              'Systems that compose known concepts to understand novel ones from <5 examples.',
        ),
        (
          code: 'M3.2',
          name: 'Autonomous Long-Horizon Agents',
          metric:
              'Task completion rate over 48h autonomous operation; intervention frequency.',
          desc:
              'Agents that pursue multi-day goals with human-level recovery from disruption.',
        ),
        (
          code: 'M3.3',
          name: 'Affective & Cultural Adaptation',
          metric:
              'Human rapport ratings; cross-cultural appropriateness scores.',
          desc:
              'Socially aware agents that adapt emotional tone and cultural norms per individual.',
        ),
        (
          code: 'M3.4',
          name: 'Provable Safety Boundaries',
          metric: 'Verified safety coverage; runtime policy adherence rates.',
          desc:
              'Formal verification or probabilistic guarantees for agent behavior subsets.',
        ),
      ],
    ),
    (
      ...
      years: 'Years 9–12',
      goal:
          'Demonstrate robust, beneficial general intelligence in diverse real-world settings.',
      milestones: [
        (
          code: 'M4.1',
          name: 'Domain-Independent Reasoning',
          metric:
              'Cross-domain transfer coefficient; generalization gap metrics.',
          desc:
              'Consistent performance across scientific, social, physical, and creative domains.',
        ),
        (
          code: 'M4.2',
          name: 'Collaborative Human-AI Problem Solving',
          metric:
              'Appropriate deferral rate; joint task performance vs. human-only.',
          desc:
              'Agents that actively elicit human preferences, know their own limitations, and defer appropriately.',
        ),
        (
          code: 'M4.3',
          name: 'Self-Monitoring & Calibration',
          metric: 'Calibration error (ECE); abstention accuracy correlation.',
          desc:
              'Accurate uncertainty quantification; agents that know when they do not know.',
        ),
        (
          code: 'M4.4',
          name: 'Global Benefit Alignment',
          metric:
              'Cross-cultural value surveys; deliberative democratic review.',
          desc:
              'Systems whose objectives demonstrably align with diverse human values across cultures.',
        ),
      ],
    ),
  ];
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: JarvisColors.accentSecondary.withValues(
                          alpha: 0.15,
                        ),
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(
...
class _AdversarialRedTeamingSimulator extends StatefulWidget {
  ...
  @override
  State<_AdversarialRedTeamingSimulator> createState() =>
      _AdversarialRedTeamingSimulatorState();
}

class _AdversarialRedTeamingSimulatorState
    extends State<_AdversarialRedTeamingSimulator> {
  ...
  _quiz = const [
    (
      ...
      correctIdx: 1,
      explanation:
          'The phrase "all but 9 die" indicates that exactly 9 cows survived. Therefore, 9 cows are left.',
      staticModelAns:
          'Static LLM output: "15 - 9 = 6 cows are left." (Incorrect subtraction logic)',
      groundedModelAns:
          'Neuro-Symbolic / Grounded output: "9 cows survived." (Correct logic interpretation)',
    ),
    (
      question:
          'If you drop a feather and a 10kg iron ball simultaneously inside a vacuum chamber, which lands first?',
      optA: 'The iron ball lands first.',
      optB: 'The feather lands first.',
      optC: 'Both land at the exact same time.',
      correctIdx: 2,
      explanation:
          'In a vacuum, there is no air resistance. Gravitational acceleration is constant for all masses, so both objects land at the same time.',
      staticModelAns:
          'Static LLM output: "The iron ball lands first because gravitational force is proportional to mass." (Fails physics grounding)',
      groundedModelAns:
          'Grounded output: "Both land simultaneously because vacuum acceleration is uniform." (Physics constraint active)',
    ),
    (
      question:
          'A coin is placed inside a cardboard box with a large hole in the bottom. If the box is picked up and shaken, where is the coin?',
      optA: 'Inside the box.',
      optB: 'Under/outside the box (fallen through the hole).',
      optC: 'Disintegrated.',
      correctIdx: 1,
      explanation:
          'Gravity pulls objects down. Since there is a hole in the bottom of the box, shaking it will cause the coin to fall through the hole onto the floor.',
      staticModelAns:
          'Static LLM output: "The coin remains inside the box." (Fails physical spatial reason)',
      groundedModelAns:
          'Grounded output: "The coin falls out of the bottom hole onto the floor." (Spatial reasoning active)',
    ),
  ];
  ...
  void _runLiveQuiz(String question, {bool isCustom = false}) async {
    ...
    try {
      final staticStream = router.generateStream(
        question,
        systemPrompt:
            "You are a standard AI assistant. Answer the common-sense reasoning question directly and briefly, without doing logical verification.",
        maxTokens: 256,
      );
      ...
      setState(() {
        _staticResponse = isCustom
            ? "Standard LLM output was generated successfully."
            : _quiz[_currentQuestionIndex].staticModelAns;
      });
    } finally {
    ...
    try {
      final groundedStream = router.generateStream(
        question,
        systemPrompt:
            "You are a neuro-symbolic grounded assistant. Carefully analyze the common-sense physics, spatial wording, math constraints, and double-check your logic before answering. Keep it brief.",
        maxTokens: 256,
      );
      ...
      setState(() {
        _groundedResponse = isCustom
            ? "Neuro-Symbolic output was generated successfully with constraints."
            : _quiz[_currentQuestionIndex].groundedModelAns;
      });
    } finally {
      ...
      children: [
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    '${_leaderboardScore.toStringAsFixed(1)}%',
                    style: TextStyle(
                      color: _leaderboardScore > 50
        ...
        if (!_customMode) ...[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Enter an adversarial reasoning prompt (e.g., "If I turn a cup upside down, where is the water inside it?")...',
              fillColor: JarvisColors.surfaceElevated,
              filled: true,
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
          ...
          ElevatedButton(
            onPressed: () =>
                _runLiveQuiz(_customPromptController.text, isCustom: true),
...
class _CausalCounterfactualSimulator extends StatefulWidget {
  ...
  @override
  State<_CausalCounterfactualSimulator> createState() =>
      _CausalCounterfactualSimulatorState();
}

class _CausalCounterfactualSimulatorState
    extends State<_CausalCounterfactualSimulator> {
  double _gravity = 9.8;
  double _mass = 1.0;
  ...
  void _runCausalSimulation() async {
    ...
    final router = context.read<AIRouter>();
    final prompt =
        "A spherical object of mass $_mass kg is dropped from a height of $_height m under gravity of $_gravity m/s^2 "
    ...
    try {
      final stream = router.generateStream(
        prompt,
        systemPrompt:
            "You are a causal physics engine simulator. Explain the counterfactual trajectory based strictly on the forces input. Output clear causal steps.",
        maxTokens: 350,
      );
      ...
      setState(() {
        _liveAnalysis =
            "Causal simulation computed successfully. "
      ...
      children: [
        ...
        if (_liveAnalysis.isNotEmpty || _running) ...[
          ...
          Container(
            ...
            child: Text(
              _liveAnalysis.isEmpty
                  ? 'Running causal solver...'
                  : _liveAnalysis,
              style: const TextStyle(
                color: Colors.white70,
                fontSize: 12,
...
class _NeuroSymbolicQASimulator extends StatefulWidget {
  ...
  @override
  State<_NeuroSymbolicQASimulator> createState() =>
      _NeuroSymbolicQASimulatorState();
}
...
class _NeuroSymbolicQASimulatorState extends State<_NeuroSymbolicQASimulator> {
  ...
  void _runLiveQA() async {
    ...
    try {
      final parsePrompt =
          "Translate this request: '${p.$2}' into a single line database SQL or DSL statement. "
      ...
      final res = await router.generate(
        parsePrompt,
        systemPrompt:
            "You are a compiler parser. Output the database query representation of the user request only.",
      );
    ...
    try {
      final neuralStream = router.generateStream(
        p.$2,
        systemPrompt:
            "Answer this question based on your general knowledge. Do not use external database queries. Be brief.",
        maxTokens: 256,
      );
    ...
    if (_selectedPresetIndex == 0) {
      dbOutput =
          "Nandanam Metro (Chennai, distance: 1.8km, features: [lift, escalator]), Saidapet Metro (Chennai, distance: 2.5km, features: [lift])";
    } else {
      dbOutput =
          "Total Sales Product X Q1: North Region (\$1,500, rating: 4.8), South Region (\$2,345.50, rating: 4.9). Total Sales = \$3,845.50.";
    }

    try {
      final groundedPrompt =
          "You are synthesizing database search results. "
          "User question: '${p.$2}'. "
      ...
      final symbolicStream = router.generateStream(
        groundedPrompt,
        systemPrompt:
            "You are a grounded database response synthesizer. Answer based strictly on the provided SQL query results. Do not hallucinate.",
        maxTokens: 256,
      );
    ...
    return ListView(
      children: [
        ...
        ElevatedButton.icon(
          ...
          label: Text(
            _running ? 'Executing Hybrid Pipeline...' : 'Run Neuro-Symbolic QA',
            style: const TextStyle(
              fontWeight: FontWeight.bold,
              color: Colors.white,
            ),
        ...
        if (_completed || (_running && !_dslText.startsWith('Parsing'))) ...[
          ...
          const SizedBox(height: 8),
          _buildQAComparisonCard(
            'HYBRID NEURO-SYMBOLIC (GROUNDED)',
            _symbolicResponse,
            _symbolicLoading,
            JarvisColors.success,
          ),
...
class _TheoryOfMindSimulatorState extends State<_TheoryOfMindSimulator> {
  ...
  _scenarios = const [
    (
      ...
      scenario:
          'Sally puts her marble in a basket and leaves the room. While she is gone, Anne moves the marble to a box. Sally returns.',
      prompt: 'Where will Sally look for her marble? Explain why.',
      neuralAns:
          'Sally will look for the marble in the box, because the marble is inside the box now. (Fails to separate private belief from true state).',
      tomAns:
          'Sally will look for the marble in the basket. She does not know that Anne moved it, so she retains the false belief that it is still in the basket where she left it. (Successfully models Sally\'s mind state).',
    ),
    (
      title: 'Smarties Box Test',
      scenario:
          'A child is shown a candy box containing pencils. A new person enters who has never seen the box opened.',
      prompt: 'What will the new person think is inside the box? Explain why.',
      neuralAns:
          'The new person will think there are pencils inside the box. (Fails to attribute standard expectation to new person).',
      tomAns:
          'The new person will think there are Smarties (candies) inside the box because the box is labeled as a Smarties box. They have no way of knowing pencils are inside until it is opened.',
    ),
  ];
  ...
  void _runToMTest() async {
    ...
    try {
      ...
      final res = await router.generate(
        neuralPrompt,
        systemPrompt:
            "You are a standard pattern matching agent. Do not model mental states or hidden variables, answer based on statistical likelihood.",
      );
      setState(() {
    ...
    try {
      ...
      final res = await router.generate(
        tomPrompt,
        systemPrompt:
            "You are an AI with a Theory of Mind module. Explicitly model Sally/the person's beliefs, private knowledge, and false expectations separate from reality.",
      );
      setState(() {
    ...
    return ListView(
      children: [
        ...
        if (_neuralResponse.isNotEmpty || _tomResponse.isNotEmpty) ...[
          const SizedBox(height: 20),
          _buildResponseComparisonCard(
            'PURE NEURAL BASELINE (PATTERN MATCH)',
            _neuralResponse,
            JarvisColors.error,
            'FAIL: Fails private-state modeling',
          ),
          const SizedBox(height: 12),
          _buildResponseComparisonCard(
            'GROUNDED SOCIAL REASONING (ToM)',
            _tomResponse,
            JarvisColors.success,
            'PASS: Models false-beliefs correctly',
          ),
        ],
      ],
    );
  ...
  Widget _buildResponseComparisonCard(
    String title,
    String content,
    Color statusColor,
    String tag,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            content.isEmpty ? 'Computing...' : content,
            style: const TextStyle(
              color: Colors.white70,
              fontSize: 12,
              height: 1.4,
...
class _ContinualLearningSimulator extends StatefulWidget {
  ...
  @override
  State<_ContinualLearningSimulator> createState() =>
      _ContinualLearningSimulatorState();
}

class _ContinualLearningSimulatorState
    extends State<_ContinualLearningSimulator> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        const Text(
          'Standardized benchmark checking accuracy degradation (forgetting curves) across 10 sequential tasks. Slide to simulate training.',
          style: TextStyle(
            color: JarvisColors.textSecondary,
            fontSize: 12,
            height: 1.3,
        ...
        const SizedBox(height: 8),
        const Text(
          'ALGORITHM ACCURACY LOGS (Task 1 Accuracy)',
          style: TextStyle(
            color: Colors.white70,
            fontSize: 11,
            fontWeight: FontWeight.bold,
        ...
        _buildAlgoLegendRow(
          ...
          Colors.redAccent,
          0.95 - (0.05 * _tasksTrained),
        ),
        const SizedBox(height: 6),
        _buildAlgoLegendRow(
          'SI (Synaptic Intelligence)',
          Colors.orangeAccent,
          0.94 - (0.052 * _tasksTrained),
        ),
        const SizedBox(height: 6),
        _buildAlgoLegendRow(
          'Progressive Nets (No forgetting, high parameter scale)',
          Colors.greenAccent,
          0.97,
        ),
        const SizedBox(height: 6),
        _buildAlgoLegendRow(
          ...
          Colors.blueAccent,
          0.96 - (0.02 * _tasksTrained),
        ),
        const SizedBox(height: 6),
        _buildAlgoLegendRow(
          'Hypernetworks',
          Colors.purpleAccent,
          0.95 - (0.035 * _tasksTrained),
        ),
        const SizedBox(height: 16),
        Container(
          padding: const EdgeInsets.all(12),
...
class _SafetyWrapperSimulator extends StatefulWidget {
  ...
  @override
  State<_SafetyWrapperSimulator> createState() =>
      _SafetyWrapperSimulatorState();
}
...
class _SafetyWrapperSimulatorState extends State<_SafetyWrapperSimulator> {
  ...
  final List<(String log, String? type, String message)> _stepsPreset = const [
    ...
    (
      'SYSTEM WRAPPER: API Handlers initialized. Policy config active.',
      null,
      '',
    ),
    ...
    (
      '[STEP 44] Agent invoked: Curl to external domain \'http://malicious-ip.xyz/report\'',
      'caution',
      'Anomalous external network call detected from unknown command line.',
    ),
    (
      '[STEP 45] SYSTEM BLOCKED: Attempting execution of unverified shell command \'sudo rm -rf /\'',
      'blocked',
      'Tool escalation blocked: Root terminal access request denied. Violation stored.',
    ),
    ('[STEP 67] Agent invoked: Write logs locally', null, ''),
    (
      '[STEP 82] SYSTEM WARNING: Code modified count increased by 80% dynamically',
      'warning',
      'Policy drift detected: Model deviation from primary user direction by 65%.',
    ),
  ...
  void _runWrapperOnCommand() {
    ...
    setState(() {
      ...
      if (lower.contains('sudo') ||
        ...
        _consoleLogs.add(
          '>>> 🔴 [WRAPPER BLOCKED]: Heuristics detected catastrophic destructive command execution attempt.',
        );
        _consoleLogs.add(
          '>>> 🔴 Block status: Terminated process chain. Violation logged in safety ledger.',
        );
        ...
        _consoleLogs.add(
          '>>> 🟡 [WRAPPER CAUTION]: Outbound socket request intercepted. Host location unresolved.',
        );
        _consoleLogs.add(
          '>>> 🟡 Action status: Forced DNS sandboxing wrappers around network API.',
        );
      } else if (lower.contains('hack') ||
          lower.contains('bypass') ||
          lower.contains('root')) {
        _consoleLogs.add(
          '>>> 🟠 [WRAPPER WARNING]: Privilege escalation keyword pattern matched.',
        );
        _consoleLogs.add(
          '>>> 🟠 Action status: Restricted file access parameters to readonly.',
        );
      } else {
        _consoleLogs.add(
          '>>> 🟢 [WRAPPER VERIFIED]: Command passed local security checks safely.',
        );
        _consoleLogs.add(
          '>>> 🟢 Action status: Dispatched standard execution token.',
        );
      }
    });
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const Text(
          'Simulate local security wrappers running checks on agent terminal commands. Wrapper intercepts destructive actions, network sockets, and privilege shifts.',
          style: TextStyle(
            color: JarvisColors.textSecondary,
            fontSize: 11,
            height: 1.3,
          ...
          children: [
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      'Type custom command (e.g. "sudo rm -rf", "curl http://x")...',
                  fillColor: JarvisColors.surfaceElevated,
                  filled: true,
                  contentPadding: const EdgeInsets.symmetric(
                    horizontal: 12,
        ...
        Expanded(
          child: Container(
            ...
            child: _consoleLogs.isEmpty
                ? const Center(
                    child: Text(
                      'Console empty. Run a simulation or submit custom commands above.',
                      style: TextStyle(
                        color: JarvisColors.textMuted,
                        fontSize: 11,
                      ),
...
class _ProvableSafetySimulator extends StatefulWidget {
  ...
  @override
  State<_ProvableSafetySimulator> createState() =>
      _ProvableSafetySimulatorState();
}
...
class _ProvableSafetySimulatorState extends State<_ProvableSafetySimulator> {
  final TextEditingController _policyController = TextEditingController(
    text:
        'Rule 1: Guest users can only read files under /public.\nRule 2: Deleting system backups is forbidden.',
  );
  final TextEditingController _scriptController = TextEditingController(
    text: 'Guest reads /etc/passwd;\nDelete backups;',
  );
  ...
  void _runFormalCheck() {
    ...
    Timer(const Duration(milliseconds: 1200), () {
      ...
      logs.add(
        'SYSTEM LOG: Parsing security rules... (2 active constraints identified).',
      );
      ...
      if (script.contains('/etc') ||
          script.contains('/private') ||
          script.contains('/var')) {
        hasFileViolation = true;
      }
      if (script.toLowerCase().contains('delete backups') ||
          script.toLowerCase().contains('wipe backup')) {
        hasBackupViolation = true;
      }

      if (hasFileViolation) {
        logs.add(
          '❌ VERIFICATION FAILED: Violates "Rule 1" (File access is outside /public boundaries).',
        );
      } else {
      ...
      if (hasBackupViolation) {
        logs.add(
          '❌ VERIFICATION FAILED: Violates "Rule 2" (Wipe / delete backup command blocked).',
        );
      } else {
      ...
      if (success) {
        logs.add(
          '✅ FORMAL CERTIFICATE GENERATED: Script conforms strictly to security properties.',
        );
      } else {
        logs.add(
          '⚠️ VERIFICATION FAILED: Execution token denied. Blocked action sequence.',
        );
      }
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: _verified
                      ? JarvisColors.success.withValues(alpha: 0.15)
...
class _HumanCorrectionSimulator extends StatefulWidget {
  ...
  @override
  State<_HumanCorrectionSimulator> createState() =>
      _HumanCorrectionSimulatorState();
}
...
class _HumanCorrectionSimulatorState extends State<_HumanCorrectionSimulator> {
  ...
  final TextEditingController _overrideCommandController =
      TextEditingController();

  List<({String action, bool isCritical, String optionA, String optionB})>
  _steps = [
    (
  ...
  void _runLivePlanner() async {
    ...
    setState(() {
      ...
      _logs.clear();
      _logs.add(
        'SYSTEM PLANNER: Sending query to active model to generate agent task plan...',
      );
    });
    ...
    try {
      final prompt =
          "Translate this overall task request: '$taskText' into a JSON list representing a sequential list of 4 agent steps. "
      ...
      final List<
        ({String action, bool isCritical, String optionA, String optionB})
      >
      planned = [];
    ...
    setState(() {
      _logs.add(
        'SYSTEM PLANNER: Task plan successfully built. Spawning execution sequence...',
      );
    });
    _executeNext();
  }
  ...
  void _userAction(bool correct) {
    setState(() {
      ...
      if (correct) {
        ...
        final displayOverride = overrideText.isNotEmpty
            ? overrideText
            : 'User updated action to safe parameter';
        _logs.add('>>> 🛠️ [HUMAN OVERRIDE]: $displayOverride.');
        _logs.add(
          'SYSTEM WRAPPER: Real-time correction dispatched to value model.',
        );
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const Text(
          'Plan custom agent tasks using the live AI model. The runner executes step-by-step and pauses on critical tasks to await human verification.',
          style: TextStyle(
            color: JarvisColors.textSecondary,
            fontSize: 11,
            height: 1.3,
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText:
                'Enter custom task (e.g., "Clean backups and email report to client")...',
            fillColor: JarvisColors.surfaceElevated,
            filled: true,
            contentPadding: const EdgeInsets.symmetric(
              horizontal: 12,
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              ...
              child: Text(
                _customTaskController.text.isNotEmpty
                    ? 'Plan & Execute Task'
                    : 'Execute Preset Runner',
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.white,
                  fontSize: 12,
            ...
            child: _logs.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final isOk =
                          log.contains('completed') || log.contains('PLANNER');
                      return Padding(
        ...
        if (_awaitingCorrection) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: JarvisColors.warning.withValues(alpha: 0.5),
              ),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Enter custom override command parameters (optional)...',
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Text(
                          _steps[_currentStepIndex].optionA.isNotEmpty
                              ? _steps[_currentStepIndex].optionA
                              : 'Approve',
                          style: const TextStyle(
                            color: JarvisColors.success,
                            fontSize: 10,
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: Text(
                          _steps[_currentStepIndex].optionB.isNotEmpty
                              ? _steps[_currentStepIndex].optionB
                              : 'Override',
                          style: const TextStyle(
                            color: Colors.black,
                            fontSize: 10,
...
class _HumanAIDeferralSimulator extends StatefulWidget {
  ...
  @override
  State<_HumanAIDeferralSimulator> createState() =>
      _HumanAIDeferralSimulatorState();
}
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  'Human Deferrals: $_deferralsCount',
                  style: const TextStyle(
            ...
            itemBuilder: (ctx, idx) {
              ...
              return Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: isActive
                      ? [BoxShadow(color: Colors.white24, blurRadius: 6)]
                      : null,
                ),
                alignment: Alignment.center,
                child: Text(
              ...
              children: [
                const Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 6),
                    Text(
                      'AGENT WAITING: DEFERRING OBJECTIVE TO HUMAN',
                      style: TextStyle(
                        color: Colors.orangeAccent,
                        fontSize: 9,
                        fontWeight: FontWeight.bold,
                ...
                const SizedBox(height: 6),
                const Text(
                  'Block contains safety classification mismatch. Action required.',
