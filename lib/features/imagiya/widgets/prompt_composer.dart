        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Describe your image... e.g. "A futuristic Tamil Nadu cityscape at sunset"',
            ...
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<ImageResolution>(
                  ...
                  items: const [
                    DropdownMenuItem(
                      value: ImageResolution.standard,
                      child: Text('Standard (512)'),
                    ),
                    DropdownMenuItem(
                      value: ImageResolution.hd,
                      child: Text('HD (1024)'),
                    ),
                    DropdownMenuItem(
                      value: ImageResolution.fullhd,
                      child: Text('Full HD (1920)'),
                    ),
                  ],
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                widget.isLoading ? 'Generating...' : 'Generate with Imagiya',
              ),
