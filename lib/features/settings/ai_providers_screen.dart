...
const List<_ProviderInfo> _providers = [
  _ProviderInfo(
    ...
    description:
        'Gemini 2.0 Flash, Pro and Ultra models. Deep integration with Google Workspace. '
  ...
  _ProviderInfo(
    ...
    description:
        'Access the world\'s largest collection of optimized AI models via NVIDIA\'s cloud. '
  ...
  _ProviderInfo(
    ...
    description:
        'Claude 3.5 Sonnet and Claude 3 Opus — the gold standard for coding, analysis, '
  ...
  _ProviderInfo(
    ...
    description:
        'One API key, all frontier models. DeepSeek V3, Kimi K2, GPT-4o, Claude, Llama, '
  ...
  _ProviderInfo(
    ...
    description:
        'Download and run open-source models directly on your machine. '
  ...
  _ProviderInfo(
    ...
    description:
        'Access Ollama-compatible open models via cloud API. No local GPU needed. '
  ...
  _ProviderInfo(
    ...
    description:
        'Self-hosted llama.cpp OpenAI-compatible server. Run any GGUF model '
                                ...
                                children: [
                                  ...
                                  if (provider.hasFree) ...[
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: JarvisColors.success.withValues(
                                          alpha: 0.15,
                                        ),
