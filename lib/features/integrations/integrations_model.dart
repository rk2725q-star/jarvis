...
const List<AIIntegration> kAIIntegrations = [
  ...
  AIIntegration(
    ...
    name: 'Arena.ai',
    description:
        'Compare multiple AI models side by side in real-time battles.',
    url: 'https://arena.ai',
    ...
    agentJsHint:
        'Find the main text input (placeholder: "Ask anything..."), type the query, then click the submit/arrow button to run.',
  ),
  AIIntegration(
    id: 'designarena',
    name: 'Design Arena',
    ...
    agentJsHint:
        'Find the design prompt input field and type the query. Click the Generate or Submit button.',
  ),
  AIIntegration(
    id: 'claude',
    name: 'Claude',
    ...
    agentJsHint:
        'Find the main chat textarea, type the query, and press Enter or click Send.',
  ),
  AIIntegration(
    id: 'chatgpt',
    name: 'ChatGPT',
    ...
    agentJsHint:
        'Find the chat textarea with id="prompt-textarea", type the query, then press Enter.',
  ),
  AIIntegration(
    id: 'gemini',
    name: 'Gemini',
    description:
        "Google's most capable AI, deeply integrated with Google apps.",
  ...
  AIIntegration(
    ...
    agentJsHint:
        'Navigate to the search URL with the query pre-filled. It will auto-run.',
  ),
  AIIntegration(
    id: 'poe',
    name: 'Poe',
  ...
  AIIntegration(
    ...
    name: 'HuggingFace',
    description:
        'The AI community — thousands of open-source models & datasets.',
  ...
  AIIntegration(
    ...
    agentJsHint:
        'Click Compose button, fill To/Subject fields and body, then click Send.',
  ),
  AIIntegration(
    id: 'youtube',
    name: 'YouTube',
    ...
    agentJsHint:
        'Navigate to the search URL with the query. Auto results will show.',
  ),
  AIIntegration(
    id: 'drive',
    name: 'Google Drive',
  ...
  AIIntegration(
    ...
    agentJsHint:
        'Type the search query in the Google search box and press Enter.',
  ),
  AIIntegration(
    id: 'googledocs',
    name: 'Google Docs',
    ...
    agentJsHint:
        "Click 'New' or '+' to create a document. Type in the document body.",
  ),
  AIIntegration(
    id: 'notebooklm',
    name: 'NotebookLM',
    ...
    agentJsHint:
        'Create a new notebook or open an existing one. Use the chat panel to ask questions.',
  ),
  ...
  AIIntegration(
    ...
    agentJsHint:
        "Click 'Add New' → 'Project' to deploy. Use the search bar for existing projects.",
  ),
  AIIntegration(
    id: 'supabase',
    name: 'Supabase',
    ...
    agentJsHint:
        'Navigate to your project. Use the SQL editor tab to run queries.',
  ),
  AIIntegration(
    id: 'msword',
    name: 'Word Online',
  ...
  AIIntegration(
    ...
    agentJsHint:
        'Use the search icon to find users or hashtags. Click the + icon to create a post.',
  ),
  AIIntegration(
    id: 'whatsapp',
    name: 'WhatsApp Web',
    ...
    agentJsHint:
        'Find contact by clicking search (magnifying glass). Click new chat, type message in input.',
  ),
  AIIntegration(
    id: 'telegram',
    name: 'Telegram',
    ...
    agentJsHint:
        'Click the search icon to find chats. Click a chat, type message in the input at the bottom.',
  ),
...
IntegrationMatch? matchIntegration(String query, {Set<String>? connectedOnly}) {
  ...
  final taskQuery = query
      .replaceAll(
        RegExp(
          r'(open|use|go to|launch|search on|via|with|using|in|on|at)\s+',
          caseSensitive: false,
        ),
        '',
      )
